...
but uses tmux instead of screen. Unlike tmux, screen doesn't have the concept of panes, 
so this script was adapted to account for them. 

**Note:** If you use a version of tmux ealier than 1.3, you should use the stable
